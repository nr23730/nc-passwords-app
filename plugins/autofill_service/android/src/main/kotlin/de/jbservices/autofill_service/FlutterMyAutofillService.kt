...
class FlutterMyAutofillService : AutofillService() {
    ...
    private var unlockLabel = "Nextcloud Passwords"
    ...
    override fun onConnected() {
        ...
        metaData.getString("de.jbservices.autofill_service.unlock_label")?.let {
            unlockLabel = it
        }
...
//        applicationContext.packageManager.getLaunchIntentForPackage(applicationContext.packageName)
        ...
        startIntent.setClassName(applicationContext, "de.jbservices.nc_passwords_app.MainActivity")
